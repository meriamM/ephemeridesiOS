...
@implementation EphemeridesAppDelegate
...
{    
    ...
    s.managedObjectContext = context;
    /* NSError *error = nil;
    ...
    Synchroniseur *s=[[Synchroniseur alloc]init];
    importe= [s importFromServerData: data];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"EphemeridesIOSVersion.sqlite"];
